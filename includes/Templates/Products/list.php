<div class="wrap">
    ...
    <div style="display: flex; margin-bottom: 20px; flex-wrap: wrap; gap: 20px;">
        ...
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <a href="<?php echo admin_url('admin-post.php?action=ppc_export_products_xml'); ?>" class="button button-secondary">
                <?php echo esc_html__( 'Export XML', 'printing-pricing-calculator' ); ?>
            </a>
        </div>
    ...
    <table class="wp-list-table widefat fixed striped">
        ...
        <thead>
            ...
            <tr>
                ...
                <th><?php echo esc_html__( 'Display with Price', 'printing-pricing-calculator' ); ?></th>
            ...
            <?php else: ?>
                ...
                <?php foreach ($products as $product): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $product['with_price'] ? esc_html__( 'Yes', 'printing-pricing-calculator' ) : esc_html__( 'No', 'printing-pricing-calculator' ); ?></td>
