...
<div class="ppc-param-row" data-param-id="<?php echo $param['id']; ?>" style="margin-bottom: 20px; border: 1px solid #ddd; padding: 10px;">
    <div class="ppc-param-header" style="display:flex;align-items:center;cursor:pointer;user-select:none;padding:10px;">
        <span class="ppc-param-drag" style="cursor:move; font-size:20px; margin-right:10px;">&#9776;</span>
        <input type="hidden" name="param_positions[]" class="ppc-param-position" value="<?php echo $index; ?>" />
    ...
    <div class="ppc-param-details" style="display:none; padding:10px 10px 0 38px;">
