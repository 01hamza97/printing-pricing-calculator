            ...
            <table class="widefat striped" style="margin-bottom:16px;">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th style="width:25%;"><?php echo esc_html__( 'Option', 'printing-pricing-calculator' ); ?></th>
                        ...
                        <th style="width:10%;"><?php echo esc_html__( 'Flat Price', 'printing-pricing-calculator' ); ?></th>

                        <th style="width:10%;"><?php echo esc_html__( 'Select', 'printing-pricing-calculator' ); ?></th>

                        <th style="width:25%;"><?php echo esc_html__( 'Conditions', 'printing-pricing-calculator' ); ?></th>
                    ...
                    <?php foreach ($options as $opt): ?>
                        ...
                        <tr data-option-id="<?php echo $opt_id; ?>">
                            ...
                            <td>
                                ...
                                <input type="checkbox" name="is_flat[<?php echo $opt_id; ?>]" value="1" <?php checked(!empty($data['option_flat'][$opt_id])); ?> />
