<div class="wrap">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><?php echo esc_html__( 'Express Delivery Description', 'printing-pricing-calculator' ); ?></th>
                <td>
                    <?php
                        wp_editor(get_option('ppc_express_delivery_desc', ''), 'express_delivery_desc', [
                            'textarea_name' => 'express_delivery_desc',
                            'textarea_rows' => 4,
                            'media_buttons' => false,
                        ]);
                    ?>
                    <p class="description"><?php echo esc_html__( 'Hover tooltip description for the Express Delivery checkbox on product pages.', 'printing-pricing-calculator' ); ?></p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th scope="row"><?php echo esc_html__( 'File Check Description', 'printing-pricing-calculator' ); ?></th>
                <td>
                    <?php
                        wp_editor(get_option('ppc_file_check_desc', ''), 'file_check_desc', [
                            'textarea_name' => 'file_check_desc',
                            'textarea_rows' => 4,
                            'media_buttons' => false,
                        ]);
                    ?>
                    <p class="description"><?php echo esc_html__( 'Hover tooltip description for the File Check checkbox on product pages.', 'printing-pricing-calculator' ); ?></p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th scope="row"><?php echo esc_html__( 'R2 ACCOUNT ID', 'printing-pricing-calculator' ); ?></th>
                <td>
                    <input type="text" name="R2_ACCOUNT_ID" value="<?php echo esc_attr(get_option('R2_ACCOUNT_ID', '')); ?>" class="regular-text" />
                </td>
            </tr>
            <tr>
                <th scope="row"><?php echo esc_html__( 'R2 ACCESS KEY ID', 'printing-pricing-calculator' ); ?></th>
                <td>
                    <input type="text" name="R2_ACCESS_KEY_ID" value="<?php echo esc_attr(get_option('R2_ACCESS_KEY_ID', '')); ?>" class="regular-text" />
                </td>
            </tr>
            <tr>
                <th scope="row"><?php echo esc_html__( 'R2 SECRET ACCESS KEY', 'printing-pricing-calculator' ); ?></th>
                <td>
                    <input type="text" name="R2_SECRET_ACCESS_KEY" value="<?php echo esc_attr(get_option('R2_SECRET_ACCESS_KEY', '')); ?>" class="regular-text" />
                </td>
            </tr>
            <tr>
                <th scope="row"><?php echo esc_html__( 'R2 PUBLIC BASE URL', 'printing-pricing-calculator' ); ?></th>
                <td>
                    <input type="text" name="R2_PUBLIC_BASE" value="<?php echo esc_attr(get_option('R2_PUBLIC_BASE', '')); ?>" class="regular-text" />
                </td>
            </tr>
            <tr>
                <th scope="row"><?php echo esc_html__( 'R2 BUCKET', 'printing-pricing-calculator' ); ?></th>
                <td>
                    <input type="text" name="R2_BUCKET" value="<?php echo esc_attr(get_option('R2_BUCKET', '')); ?>" class="regular-text" />
                </td>
            </tr>
        </table>
        <p class="submit">
